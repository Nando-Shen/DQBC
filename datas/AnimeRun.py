...
class AnimeRun_train(data.Dataset):
    def __init__(self, args):
        ...
        self.meta_data = os.listdir(os.path.join(self.data_root, 'train/contourcopy'))
        self.image_root = os.path.join(self.image_root, 'train/contourcopy')
...
class AnimeRun_validation(data.Dataset):
    def __init__(self, args):
        self.sequence_list = []
        ...
        self.data_root = args.dataset_root
        self.image_root = self.data_root
        self.meta_data = os.listdir(os.path.join(self.data_root, 'test/contourcopy'))
        self.sequence_list = self.meta_data
        self.image_root = os.path.join(self.image_root, 'test/contourcopy')
